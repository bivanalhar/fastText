...
class FastText {
 protected:
  ...
  std::shared_ptr<Dictionary> spell_;
  ...
  void skipgram_main(Model::State& state, real lr, const std::vector<int32_t>& line);
  void skipgram_spell(Model::State& state, real lr, const std::vector<int32_t>& line);
